              ...
              {users.length === 0 ? (
                ...
                users.map((u) => (
                  <tr key={u.id}>
                    ...
                    <td>
                      <span
                        className={`badge ${u.isActive ? 'badge--completed' : 'badge--returned'}`}
                      >
                      ...
                      <div className="table-actions">
                        ...
                        {u.isActive ? (
                          <button
                            ...
                            title="Desativar"
                            onClick={() =>
                              setConfirmAction({ user: u, type: 'deactivate' as const })
                            }
                            style={{ color: '#D97706' }}
                          >
                            Desativar
        ...
        <div className="modal-overlay" onClick={() => setConfirmAction(null)}>
          <div className="modal-card" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '440px' }}>
            ...
            <div className="modal-footer">
              ...
              <button
                className={confirmAction.type === 'activate' ? 'btn-save' : 'btn-danger'}
